...
Q3 <- read.csv("~/Documents/BPsychSci/SIT191/Data/Wk9/Q3.csv", row.names = 1, header = TRUE, sep = ",")
Q5 <- read.csv("~/Documents/BPsychSci/SIT191/Data/Wk9/Q5.csv", header = TRUE, sep = ",")
Q8 <- read.csv("~/Documents/BPsychSci/SIT191/Data/Wk9/Q8.csv", header = TRUE, sep = ",")
Q9 <- read.csv("~/Documents/BPsychSci/SIT191/Data/Wk9/Q9.csv", row.names = 1, header = TRUE, sep = ",")
Q14 <- read.csv("~/Documents/BPsychSci/SIT191/Data/Wk9/Q14.csv", header = TRUE, sep = ",")
```
